...
import com.example.loginapp.TodoDestinationsArgs.TASK_ID_ARG
import com.example.loginapp.TodoDestinationsArgs.TITLE_ARG
import com.example.loginapp.TodoDestinationsArgs.USER_MESSAGE_ARG
import com.example.loginapp.TodoScreens.ADD_EDIT_TASK_SCREEN
import com.example.loginapp.TodoScreens.LOGIN_SCREEN
import com.example.loginapp.TodoScreens.MAIN_SCREEN
import com.example.loginapp.TodoScreens.STATISTICS_SCREEN
import com.example.loginapp.TodoScreens.TASKS_SCREEN
import com.example.loginapp.TodoScreens.TASK_DETAIL_SCREEN
...
class TodoNavigationActions(private val navController: NavHostController) {
    ...
    fun navigateToMain() {
        navController.navigate(TodoDestinations.MAIN_ROUTE) {
